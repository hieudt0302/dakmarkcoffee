...
Route::post('/add-to-wishlist', ['uses'=> 'Front\ProductsController@addToWishlist', 'middleware' => 'auth']);
...
/* GALLERIES */
Route::get('/album-dakmark', 'Front\GalleriesController@index');
...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'middleware' => 'auth'], function() {
   ...
   //Order
    ...
    Route::delete('orders/{id}/notes/{note_id}',['as'=>'admin.orders.show','uses'=>'OrdersController@destroynote','middleware' => ['role:admin|manager']]);
